...
- كل قالب يستخدم `{{ .Token }}` ولا يستخدم روابط التأكيد
...
بعد تعديل أي قالب في المستودع يجب نسخ محتواه نفسه إلى Authentication ثم Emails ثم Templates داخل Supabase Dashboard
